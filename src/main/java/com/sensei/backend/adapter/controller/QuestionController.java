...
public class QuestionController {
    ...
    @PutMapping("/{id}")
    public QuestionResponseDTO update(@PathVariable UUID id, @RequestBody QuestionRequestDTO dto) {
    ...
    public List<QuestionResponseDTO> getByDigitalActivity(@PathVariable UUID digitalActivityId) {
