...
public class SubModuleController {
    ...
    public ResponseEntity<List<SubModuleResponseDTO>> getByModule(@PathVariable UUID moduleId) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SubModuleResponseDTO> update(@PathVariable UUID id, @RequestBody SubModuleRequestDTO dto) {
