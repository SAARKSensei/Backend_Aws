...
import com.sensei.backend.application.dto.digitalactivity.*;
import com.sensei.backend.domain.service.DigitalActivityService;
...
public class DigitalActivityController {
    ...
    @PutMapping("/{id}")
    public DigitalActivityResponseDTO update(@PathVariable UUID id, @RequestBody DigitalActivityRequestDTO dto) {
    ...
    public List<DigitalActivityResponseDTO> getBySubModule(@PathVariable UUID subModuleId) {
